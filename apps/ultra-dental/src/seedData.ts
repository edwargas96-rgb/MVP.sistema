  ...
  orders: [
    {
      ...
      eventos: [
        { id: "evt-1", status: "Caso recebido", comentario: "Arquivos STL recebidos via 3Shape.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(6) },
        { id: "evt-2", status: "Arquivos conferidos", comentario: "Escaneamento validado, sem ruídos.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(5) },
        { id: "evt-3", status: "Planejamento digital", comentario: "Design CAD da barra concluído.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(5) },
        { id: "evt-4", status: "Aguardando aprovação", comentario: "Planejamento enviado ao cirurgião para aprovação.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(4) },
        ...
        { id: "evt-6", status: "Fresagem ou impressão", comentario: "Fresagem em centro de usinagem de 5 eixos em andamento.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(2) },
      ],
      criadaEm: daysAgo(6),
    },
    {
      ...
      status: "Caracterização e acabamento",
      arquivos: [
        { id: "file-3", nome: "escaneamento_medit.ply", tipo: "arquivo", extensao: "ply", tamanhoKb: 4700, criadoEm: daysAgo(8) },
      ],
      eventos: [
        { id: "evt-7", status: "Caso recebido", comentario: "Arquivo PLY recebido via Medit.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(8) },
        { id: "evt-8", status: "Planejamento digital", comentario: "Mock-up digital enviado para aprovação estética.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(6) },
        ...
        { id: "evt-10", status: "Caracterização e acabamento", comentario: "Estratificação e glazeamento em andamento.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(1) },
      ],
      criadaEm: daysAgo(8),
    },
    {
      ...
      status: "Arquivos conferidos",
      arquivos: [],
      eventos: [
        { id: "evt-11", status: "Caso recebido", comentario: "Planejamento recebido via iTero.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(3) },
        { id: "evt-12", status: "Arquivos conferidos", comentario: "Validando posicionamento dos implantes no guia.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(2) },
      ],
      criadaEm: daysAgo(3),
    },
    {
      ...
      eventos: [
        { id: "evt-13", status: "Caso recebido", comentario: "Escaneamento recebido via 3Shape.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(4) },
        { id: "evt-14", status: "Planejamento digital", comentario: "Design CAD da coroa concluído.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(2) },
        { id: "evt-15", status: "Aguardando aprovação", comentario: "Planejamento pronto para aprovação da clínica.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(1) },
      ],
      criadaEm: daysAgo(4),
    },
    {
      ...
      eventos: [
        { id: "evt-16", status: "Caso recebido", comentario: "Escaneamento recebido via Cerec.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(18) },
        ...
        { id: "evt-18", status: "Controle de qualidade", comentario: "Ajuste oclusal e polimento finalizados.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(12) },
        { id: "evt-19", status: "Entregue", comentario: "Entregue à clínica dentro do prazo.", autor: "Equipe Ultra Dental Lab", criadoEm: daysAgo(9) },
      ],
      criadaEm: daysAgo(18),
    },
  ],
