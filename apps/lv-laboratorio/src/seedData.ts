  ...
  orders: [
    {
      ...
      eventos: [
        { id: "evt-1", status: "Caso recebido", comentario: "Ordem recebida via escaneamento intraoral.", autor: "Lucas de Vargas", criadoEm: daysAgo(6) },
        { id: "evt-2", status: "Em análise", comentario: "Caso avaliado — planejamento individualizado, do jeito que cada trabalho merece.", autor: "Lucas de Vargas", criadoEm: daysAgo(5) },
        { id: "evt-3", status: "Planejamento", comentario: "Protocolo definido junto à clínica.", autor: "Lucas de Vargas", criadoEm: daysAgo(4) },
    ...
    },
    {
      ...
      eventos: [
        { id: "evt-5", status: "Caso recebido", comentario: "Moldagem física recebida na portaria.", autor: "Lucas de Vargas", criadoEm: daysAgo(9) },
        { id: "evt-6", status: "Em análise", comentario: "Caso avaliado.", autor: "Lucas de Vargas", criadoEm: daysAgo(8) },
        { id: "evt-7", status: "Planejamento", comentario: "Plano de tratamento alinhado com o dentista.", autor: "Lucas de Vargas", criadoEm: daysAgo(7) },
        { id: "evt-8", status: "Em produção", comentario: "Impressão 3D do modelo concluída.", autor: "Lucas de Vargas", criadoEm: daysAgo(4) },
        { id: "evt-9", status: "Acabamento", comentario: "Acabamento finalizado com atenção aos detalhes.", autor: "Lucas de Vargas", criadoEm: daysAgo(2) },
        { id: "evt-10", status: "Aguardando aprovação", comentario: "Enviado para prova de mordida com o dentista.", autor: "Lucas de Vargas", criadoEm: daysAgo(1) },
      ],
      criadaEm: daysAgo(9),
    },
    {
      ...
      arquivos: [],
      eventos: [
        { id: "evt-11", status: "Caso recebido", comentario: "Ordem recebida.", autor: "Lucas de Vargas", criadoEm: daysAgo(10) },
        { id: "evt-12", status: "Em análise", comentario: "Caso avaliado com atenção aos detalhes clínicos.", autor: "Lucas de Vargas", criadoEm: daysAgo(8) },
        { id: "evt-13", status: "Planejamento", comentario: "Aguardando confirmação do desenho da PPR com a clínica.", autor: "Lucas de Vargas", criadoEm: daysAgo(6) },
      ],
      criadaEm: daysAgo(10),
    },
    {
      ...
      urgente: false,
      observacoes: "",
      status: "Caso recebido",
      arquivos: [],
      eventos: [
        { id: "evt-14", status: "Caso recebido", comentario: "Trabalho recebido e organizado para análise.", autor: "Lucas de Vargas", criadoEm: daysAgo(1) },
      ],
      criadaEm: daysAgo(1),
    },
    {
      ...
      eventos: [
        { id: "evt-15", status: "Caso recebido", comentario: "Arquivo STL recebido — fluxo digital.", autor: "Lucas de Vargas", criadoEm: daysAgo(20) },
        { id: "evt-16", status: "Em produção", comentario: "Impressão 3D realizada.", autor: "Lucas de Vargas", criadoEm: daysAgo(18) },
        { id: "evt-17", status: "Acabamento", comentario: "Modelo finalizado e higienizado.", autor: "Lucas de Vargas", criadoEm: daysAgo(16) },
        { id: "evt-18", status: "Pronto para entrega", comentario: "Pronto para retirada pela clínica.", autor: "Lucas de Vargas", criadoEm: daysAgo(15) },
