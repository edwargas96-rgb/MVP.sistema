...
export const seed: LabDataset = {
  ...
  catalogs: {
    servicos: [
      ...
      "Prótese provisória",
      "Impressão 3D",
      "Trabalho por escaneamento intraoral",
    ],
  ...
  orders: [
    {
      ...
      prazo: futureDate(2),
      urgente: true,
      observacoes: "Paciente com bruxismo controlado. Priorizar espessura de zircônia na região anterior.",
      status: "Em produção",
      arquivos: [
      ...
      eventos: [
        { id: "evt-1", status: "Recebida", comentario: "Ordem recebida via escaneamento intraoral.", autor: "Lucas de Vargas", criadoEm: daysAgo(6) },
        { id: "evt-2", status: "Em análise", comentario: "Planejamento do protocolo definido junto à clínica.", autor: "Lucas de Vargas", criadoEm: daysAgo(5) },
        { id: "evt-3", status: "Em produção", comentario: "Fresagem da estrutura em andamento.", autor: "Lucas de Vargas", criadoEm: daysAgo(2) },
      ],
      criadaEm: daysAgo(6),
    },
    {
      ...
      prazo: futureDate(5),
      urgente: false,
      observacoes: "Prova de mordida agendada antes do acabamento final.",
      status: "Em prova",
      arquivos: [
        { id: "file-3", nome: "moldagem_arcada.zip", tipo: "arquivo", extensao: "zip", tamanhoKb: 3200, criadoEm: daysAgo(9) },
      ],
      eventos: [
        { id: "evt-4", status: "Recebida", comentario: "Moldagem física recebida na portaria.", autor: "Lucas de Vargas", criadoEm: daysAgo(9) },
        { id: "evt-5", status: "Em produção", comentario: "Impressão 3D do modelo concluída.", autor: "Lucas de Vargas", criadoEm: daysAgo(4) },
        { id: "evt-6", status: "Em prova", comentario: "Encaminhado para prova de mordida.", autor: "Lucas de Vargas", criadoEm: daysAgo(1) },
      ],
      criadaEm: daysAgo(9),
    },
    {
      ...
      prazo: pastDate(2),
      urgente: false,
      observacoes: "Confirmar retenção dos grampos com o clínico antes do acabamento.",
      status: "Em análise",
      arquivos: [],
      eventos: [
        { id: "evt-7", status: "Recebida", comentario: "Ordem recebida.", autor: "Lucas de Vargas", criadoEm: daysAgo(10) },
        { id: "evt-8", status: "Em análise", comentario: "Aguardando confirmação do desenho da PPR.", autor: "Lucas de Vargas", criadoEm: daysAgo(8) },
      ],
      criadaEm: daysAgo(10),
    },
    {
      ...
      arquivos: [],
      eventos: [
        { id: "evt-9", status: "Recebida", comentario: "Ordem criada e recebida pelo laboratório.", autor: "Lucas de Vargas", criadoEm: daysAgo(1) },
      ],
      criadaEm: daysAgo(1),
    },
    {
