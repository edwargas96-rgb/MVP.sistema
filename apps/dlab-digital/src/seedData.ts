  ...
  orders: [
    {
      ...
      eventos: [
        { id: "evt-1", status: "Recebido", comentario: "Arquivo digital e tomografia recebidos.", autor: "Dr. Geninho Thomé", criadoEm: daysAgo(7) },
        { id: "evt-2", status: "Recebido", comentario: "Escaneamento e tomografia validados sem inconsistências.", autor: "Camila Duarte", criadoEm: daysAgo(7) },
        { id: "evt-3", status: "Recebido", comentario: "Planejamento digital da barra concluído.", autor: "Camila Duarte", criadoEm: daysAgo(6) },
        { id: "evt-4", status: "Em prova", comentario: "Enviado para aprovação da clínica.", autor: "Camila Duarte", criadoEm: daysAgo(6) },
    ...
    },
    {
      ...
      eventos: [
        { id: "evt-6", status: "Recebido", comentario: "Planejamento cirúrgico recebido.", autor: "Dr. Geninho Thomé", criadoEm: daysAgo(5) },
        { id: "evt-7", status: "Recebido", comentario: "Arquivos conferidos e liberados para planejamento.", autor: "Rodrigo Lima", criadoEm: daysAgo(4) },
        { id: "evt-8", status: "Recebido", comentario: "Posicionamento dos implantes definido no guia.", autor: "Rodrigo Lima", criadoEm: daysAgo(3) },
        { id: "evt-9", status: "Em prova", comentario: "Aguardando aprovação da clínica antes da impressão.", autor: "Rodrigo Lima", criadoEm: daysAgo(2) },
      ],
      criadaEm: daysAgo(5),
    },
    {
      ...
      arquivos: [],
      eventos: [
        { id: "evt-10", status: "Recebido", comentario: "Escaneamento recebido.", autor: "Dr. Geninho Thomé", criadoEm: daysAgo(4) },
        { id: "evt-11", status: "Recebido", comentario: "Escaneamento sem falhas de leitura.", autor: "Camila Duarte", criadoEm: daysAgo(3) },
        { id: "evt-12", status: "Recebido", comentario: "Definindo mapa de cor com o clínico.", autor: "Camila Duarte", criadoEm: daysAgo(2) },
      ],
      criadaEm: daysAgo(4),
    },
    {
      ...
      arquivos: [],
      eventos: [
        { id: "evt-13", status: "Recebido", comentario: "Trabalho recebido pela equipe DLAB Digital.", autor: "Dr. Geninho Thomé", criadoEm: daysAgo(1) },
      ],
      criadaEm: daysAgo(1),
    },
    {
      ...
      eventos: [
        { id: "evt-14", status: "Recebido", comentario: "Moldagem digital recebida.", autor: "Dr. Geninho Thomé", criadoEm: daysAgo(22) },
        { id: "evt-15", status: "Recebido", comentario: "Arquivos conferidos e liberados.", autor: "Camila Duarte", criadoEm: daysAgo(21) },
        { id: "evt-16", status: "Recebido", comentario: "Planejamento digital concluído.", autor: "Camila Duarte", criadoEm: daysAgo(20) },
        { id: "evt-17", status: "Em prova", comentario: "Projeto aprovado pela clínica.", autor: "Dra. Juliana Wroblevski", criadoEm: daysAgo(19) },
        { id: "evt-18", status: "Em produção", comentario: "Fresagem em zircônia monolítica.", autor: "Camila Duarte", criadoEm: daysAgo(18) },
        { id: "evt-19", status: "Em produção", comentario: "Acabamento e glazing concluídos.", autor: "Camila Duarte", criadoEm: daysAgo(16) },
        { id: "evt-20", status: "Em produção", comentario: "Conferência final de encaixe e oclusão.", autor: "Rodrigo Lima", criadoEm: daysAgo(15) },
        { id: "evt-21", status: "Finalizado", comentario: "Trabalho pronto para envio.", autor: "Rodrigo Lima", criadoEm: daysAgo(15) },
        { id: "evt-22", status: "Finalizado", comentario: "Entregue à clínica.", autor: "Dr. Geninho Thomé", criadoEm: daysAgo(14) },
      ],
      criadaEm: daysAgo(22),
    },
  ],
